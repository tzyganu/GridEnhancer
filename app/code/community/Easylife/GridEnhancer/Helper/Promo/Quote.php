 ...
 */
class Easylife_GridEnhancer_Helper_Promo_Quote
    extends Easylife_GridEnhancer_Helper_Abstract {
    /**
     * grid identifier
     */
    const PROMO_QUOTE_GRID_IDENTIFIER = 'promo_quote';
    /**
    ...
    public function getGridIdentifier(){
        return self::PROMO_QUOTE_GRID_IDENTIFIER;
    }
    /**
    ...
    public static function getHelperPath(){
        return Easylife_GridEnhancer_Helper_Abstract::XML_ROOT_PATH.'promo_quote/helper';
    }

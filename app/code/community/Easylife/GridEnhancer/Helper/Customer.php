 ...
 */
class Easylife_GridEnhancer_Helper_Customer
    extends Easylife_GridEnhancer_Helper_Abstract {
    /**
     * grid identifier
     */
    const CUSTOMER_GRID_IDENTIFIER = 'customer';
    /**
    ...
    public function getGridIdentifier(){
        return self::CUSTOMER_GRID_IDENTIFIER;
    }
    /**
    ...
    public static function getHelperPath(){
        return Easylife_GridEnhancer_Helper_Abstract::XML_ROOT_PATH.'customer/helper';
    }
